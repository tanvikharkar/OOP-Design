...
public class Main {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        System.out.println(Country.countryWithHighestCH4InYear(countries, 2000).getName() +
                " had the highest methane gas emission in 2000.");
        ...
        System.out.println(Country.countryWithHighestChangeInEmissions(countries, 1988, 2012).getName() +
                " had the highest increase in greenhouse gas emissions between 1988 and 2012.");

        // Which sector had the highest average greenhouse gas emissions between 1988 and 2012?
        System.out.println(Sector.sectorWithHighestAverageEmissions(sectors, 1988, 2012).getName() +
                " had the highest average greenhouse gas emissions between 1988 and 2012.");
    }
